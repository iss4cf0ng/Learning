...
// ===============================================
    ...
    assign sum = in_A + in_B; //A+B
    assign dif = in_A - in_B; //A-B
    assign op_and = in_A & in_B;
    assign op_or = in_A | in_B;
    assign op_eq = in_A == in_B;
    assign op_gt = in_A >= in_B;
    assign op_xor = in_A ^ in_B;
        ...
        S_IDLE: begin
            if (valid && (mode == 4'd9 || mode == 4'd10)) begin
                ...
                4'd0: begin //ADD
                    ...
                    */
                    case ({in_A[DATA_W-1], in_B[DATA_W-1], sum[DATA_W-1]})
                ...
                4'd1: begin //SUB
                    ...
                    */
                    case ({in_A[DATA_W-1], in_B[DATA_W-1], dif[DATA_W-1]})
                ...
                4'd6: begin //GREATER THAN
                    ...
                    */
                    case ({in_A[DATA_W-1], in_B[DATA_W-1]})
                ...
                'd7: begin //SHIFT RIGHT LOGICAL
                    shift_reg_w = {{DATA_W{1'b0}}, in_A >> in_B};
                end
